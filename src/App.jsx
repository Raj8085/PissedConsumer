...
// import AuthForms from "./component/UserCredential/Auth";
// import WriteReviewPage from "./component/UserCredential/WriteReviewPage";
// import CaptchaVerificationPage from "./component/RobotPopUp/RobotPopUp";

// const App = () => {
//   const [isCaptchaVerified, setIsCaptchaVerified] = useState(false);

//   // Check localStorage to see if CAPTCHA has been completed
//   useEffect(() => {
...
//         <main className="">
//           <Routes>
//             {/* Show CAPTCHA page if the user hasn't verified it yet */}
//             {!isCaptchaVerified && (
//               <Route path="/" element={<CaptchaVerificationPage/>} />
//             )}

//             {/* If CAPTCHA is verified, go to Home page */}
//             {isCaptchaVerified && (
//               <Route path="/" element={<Home />} />
//             )}
...
//             <Route path="/pricing" element={<Pricing />} />
//             <Route path="/blog" element={<Blog />} />
//             <Route path="/vpn/option11" element={
//               <>
//                 <Navbar />
//                 <Hero />
//                 <VPNInfoSection />
...
import AuthForms from "./component/UserCredential/Auth";
import WriteReviewPage from "./component/UserCredential/WriteReviewPage";
import { SiteHeader } from "./component/SIteHeader"; // SiteHeader Import
import Footer from "./component/RobinPage/component/Footer"; // Footer Import
import CaptchaVerificationPage from "./component/RobotPopUp/RobotPopUp";
...
const App = () => {
  ...
  // If CAPTCHA is not verified, only show the CaptchaVerificationPage
  if (!isCaptchaVerified) {
    return <CaptchaVerificationPage setIsCaptchaVerified={setIsCaptchaVerified} />;
  }

  // After CAPTCHA is verified, render the rest of the application
  return (
      <div>
        <SiteHeader />
        <main className="">
